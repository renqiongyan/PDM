...
class Goods(UserMixin, flask_db.Model):
    ...
    type = CharField(null=False, choices=(('Y', '生活用品'),('S', '食品'),('D', '电子产品'), ('Q', '其他')))
...
class Transport(UserMixin, flask_db.Model):
    ...
    state = CharField(null=False, choices=(('D', '待发货'),('Y', '运输中'),('S', '已收货')))
...
class Customer(UserMixin, flask_db.Model):
    ...
    raddress = CharField(null=False, max_length=50)
